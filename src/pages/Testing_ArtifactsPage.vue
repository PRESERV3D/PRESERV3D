<template>
  <q-page class="q-pa-md">
    ...
    <!-- For Testing -->
    <div class="artifacts-grid">
      <div v-for="(link, i) in sampleLinks" :key="i" class="artifact-card-wrapper">
        <q-card class="my-card" rounded bordered>
          <div class="card">
            <model-viewer
              :src="link"
...
const sampleLinks = ref([
  'https://jruqvzpclhwjkttxhhtt.supabase.co/storage/v1/object/public/artifacts/oiiaioooooiai_cat.glb',
  'https://jruqvzpclhwjkttxhhtt.supabase.co/storage/v1/object/public/artifacts/sample-model.glb',
  'https://jruqvzpclhwjkttxhhtt.supabase.co/storage/v1/object/public/artifacts/Can.glb',
])

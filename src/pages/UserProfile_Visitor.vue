      ...
      <div class="profile-content">
        <q-card class="profile-card">
          ...
          <div class="profile-picture-section">
            ...
            <!-- Extension Request Section (Visitor Only) -->
            <div v-if="userType === 'visitor' && !isEditing" class="extension-section q-mt-md">
              <q-btn
                outline
                color="primary"
          ...
          <div class="profile-info-section">
            ...
            <div v-if="userType === 'student'">
              <div class="info-row">
                <label>Name:</label>
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.name }}</span>
                  <q-input
                    v-else
              ...
              <div class="info-row">
                <label>Email:</label>
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.email }}</span>
                  <q-input
                    v-else
              ...
              <div class="info-row">
                <label>College:</label>
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.college }}</span>
                  <q-input
                    v-else
              ...
              <div class="info-row">
                <label>Department:</label>
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.department }}</span>
                  <q-input
                    v-else
              ...
              <div class="info-row">
                ...
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.yearSection }}</span>
                  <q-input
                    v-else
                    v-model="studentData.yearSection"
                    outlined
                    dense
                    class="edit-input"
                  />
              ...
              <div class="info-row">
                <label>Alumni:</label>
                <div class="info-content">
                  <span v-if="!isEditing">{{ studentData.isAlumni ? 'Yes' : 'No' }}</span>
                  <q-toggle
                    v-else
                    v-model="studentData.isAlumni"
                    label="Alumni"
                  />
                </div>
              </div>
              ...
              <div v-if="isEditing && studentData.password" class="info-row">
                <label>Confirm Password:</label>
                <div class="info-content">
                  <q-input
                    ...
                    placeholder="Confirm new password"
                    :type="showPassword ? 'text' : 'password'"
                    :error="studentData.password !== studentData.confirmPassword && studentData.confirmPassword !== ''"
                    error-message="Passwords do not match"
                    class="edit-input"
                  >
                    <template v-slot:append>
...
export default {
  ...
  setup() {
    ...
    // User type - change this based on logged-in user
    const userType = ref('visitor') // 'faculty', 'student', or 'visitor'
    ...
    const cancelEditing = () => {
      ...
      if (userType.value === 'faculty') {
        ...
        Object.assign(studentData, originalStudentData)
    ...
    const saveProfile = () => {
      ...
      if (userType.value === 'faculty') {
        ...
        Object.assign(originalStudentData, studentData)
        studentData.password = ''
        studentData.confirmPassword = ''
      } else if (userType.value === 'visitor') {
    ...
    const passwordsMatch = computed(() => {
      if (userType.value === 'faculty') {
        ...
        return !studentData.password || studentData.password === studentData.confirmPassword
      } else if (userType.value === 'visitor') {
